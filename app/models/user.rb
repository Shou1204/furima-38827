class User < ApplicationRecord
  ...
  validates :first_name_kanji, presence: true, format: { with: /\A(?:\p{Hiragana}|\p{Katakana}|[ー－]|[一-龠々])+\z/, message: "漢字・ひらがな・カタカナのみ使用できます" }
  validates :family_name_kanji, presence: true, format: { with: /\A(?:\p{Hiragana}|\p{Katakana}|[ー－]|[一-龠々])+\z/, message: "漢字・ひらがな・カタカナのみ使用できます" }
